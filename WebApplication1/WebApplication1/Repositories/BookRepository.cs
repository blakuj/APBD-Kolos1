...
public class BookRepository
{
    ...
    public async Task<BookDTO> GetBook(int id)
    {
        ...
        while (await reader.ReadAsync())
        {
            ...
            {
                bookDto.GenresList.Add(new GenreDTO() { genre = reader.GetString(bookGenreOrdinal) });
            }
            else
                bookDto = new BookDTO()
                {
                    ...
                    GenresList = new List<GenreDTO>() { new GenreDTO() { genre = reader.GetString(bookGenreOrdinal) } }
                };
